...
public class Fraction {
    ...
    /**
     * The numerator of the fraction.分子
     */
    private int numerator;
    /**
     * The denominator of the fraction.分母
     */
    ...
    public String toString() {
        ...
        // String ans = "" + (float) numerator / denominator;
        return "" + ((float) numerator / denominator);
    }
    ...
    private int gcd(){
        ...
        int div = 0;
        if (temp1 < temp2){ //分母大于分子
            for (int x = 0; x < temp2; x =+ 1){
                temp2 = temp2 % temp1;
                if (temp2 == 0){
                    div = temp1;
                    break;
