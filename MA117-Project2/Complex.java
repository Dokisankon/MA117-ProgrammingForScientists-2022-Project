...
public class Complex {
    ...
    public Complex multiply(Complex b) {
        // You need to fill in this method with the correct code.
        return new Complex(this.x * b.getReal() - this.y * b.getImag(), this.x * b.y + this.y * b.x);
    }
    ...
    public Complex divide(Complex b) {
        // You need to fill in this method with the correct code.
        double divider = b.getReal() * b.getReal() + b.getImag() * b.getImag();
        return new Complex((this.x * b.getReal() - this.y * -b.getImag()) / divider, (this.x * -b.y + this.y * b.x) / divider);
    }
